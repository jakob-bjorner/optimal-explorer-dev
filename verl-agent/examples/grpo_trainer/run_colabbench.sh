...
# DEBUG=GRPO_INSTRUCT_G_BG_LOG_PROB_OBS_RM_NORM BG_CEIL_RWD=-0.9 SEED=5 GRADE_BELIEF_TYPE=1 GRADE_BELIEF=25.0 bash examples/grpo_trainer/run_colabbench.sh; CKPT="qwen2.5-7b-instruct_16_seed5_sc_False_belief_promp_True_is_mem1_False_belief_lp_0_bg_25.0_1GRPO_INSTRUCT_G_BG_LOG_PROB_OBS_RM_NORM/global_step_50" STEP_RESUME=50 IS_MEM1=False INSTRUCT=True train_data_size=256 TEMPERATURE=0.01 bash examples/grpo_trainer/run_colabbench_inference.sh; CKPT="qwen2.5-7b-instruct_16_seed5_sc_False_belief_promp_True_is_mem1_False_belief_lp_0_bg_25.0_1GRPO_INSTRUCT_G_BG_LOG_PROB_OBS_RM_NORM/global_step_100" STEP_RESUME=100 IS_MEM1=False INSTRUCT=True train_data_size=256 TEMPERATURE=0.01 bash examples/grpo_trainer/run_colabbench_inference.sh
